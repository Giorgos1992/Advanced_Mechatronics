    ...
    //Set-up Timer2 to call ISR at a fixed frequency of 1kHz.
       ...
       // set up A0 as AN0
        ...
        AD1CON1bits.ADON = 1;
           ...
           int Number;
           Number = 1337;
           snprintf(Message, MAX, "Hello world %d!", Number);
           //writes message with starting location x=28, y=32;
           writemessage(Message,28,32);
           
//The following code adds a string to another. Leave here for future use
//           char buffer[30];
//           snprintf(buffer, 30,"%d", Number);
//           int m,n;
//           for (m=0;Message[m]!='\0';++m);
//           for (n=0;buffer[n]!='\0';++n, ++m)
//           {
//               Message[m]=buffer[n];
//           }
//           Message[m]='\0';
