...
//            }
            ...
            for (p=64;p<=64+accels[1]*64/16000;p++){
                display_pixel_set(31,p,0);
                display_pixel_set(32,p,0);
                display_pixel_set(33,p,0);
            }
